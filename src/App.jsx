...
function App({ utente, onLogout }) {
  ...
  const navItems = [
    ...
    { id: "agenti-ai", label: "Agenti AI", icon: "🕹️", count: null, group: "Operativo" },
    { id: "manuale", label: "Manuale operativo", icon: "📘", count: null, group: "Operativo" },
      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        ...
        <main className="main">
          ...
          /* Il valutatore resta accessibile anche a chi aspetta l'approvazione:
           ...
           inAttesa && view === "valutazione" ? <Valutazione nomeAgente={mioNome} prefill={valutaPrefill} vedoTutto={vedoTutto} /> :
           inAttesa ? (
            <div className="fi" style={{ maxWidth: 520, margin: "60px auto", textAlign: "center", background: "var(--white)", border: "1px solid var(--gl)", borderRadius: 16, boxShadow: "var(--shadow)", padding: 40 }}>
              <div style={{ fontSize: 34, marginBottom: 12 }}>⏳</div>
